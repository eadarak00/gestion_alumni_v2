...
import FormulaireInscriptionAlumni from '../../../composants/alumni/FormulaireInscriptionAlumni';
import PageValidationCode from '../../../composants/alumni/PageValidationCode';
...
const InscriptionAlumni = () => {
    ...
    const handleInscriptionSuccess = (data) => {
        console.log('Inscription Alumni réussie :', data);
    ...
    const handleValidationSuccess = () => {
        setTimeout(() => {
            globalThis.location.href = '/connexion-alumni';
        }, 1500);
    };
            ...
            <div className="max-w-[1400px] mx-auto">
                <div className="flex flex-col lg:flex-row gap-16 items-center lg:items-start justify-center">
                    ...
                    <div className="w-full lg:w-auto lg:max-w-xl order-1 lg:order-2">
                        <FormulaireInscriptionAlumni onSuccess={handleInscriptionSuccess} />
                    </div>
                </div>
            </div>
        </div>

            ...
            <main className="flex-1 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <section className="mb-10 text-center">
                    <h1 className="text-3xl font-bold text-gray-800 mb-2 tracking-tight">
                        Conditions d&apos;utilisation - Espace Alumni
                    </h1>
                ...
                <div className="space-y-8">
                        ...
                        description={
                            <>
                                ...
                                <ul className="list-disc ml-6 mt-2 text-sm text-gray-700 space-y-1">
                                    <li>Être alumni de l'université</li>
                                    <li>Fournir des informations véridiques sur votre parcours</li>
                    ...
                    <Section
                        ...
                        description={
                            <>
                                Vous bénéficiez de services dédiés à la communauté alumni : annuaire des anciens,
                                offres d'emploi, mentorat, et événements de réseautage.
                            </>
                        }
                    />

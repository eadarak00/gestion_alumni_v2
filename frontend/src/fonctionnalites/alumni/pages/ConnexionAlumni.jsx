...
import FormulaireConnexionAlumni from '../../../composants/alumni/FormulaireConnexionAlumni';

const ConnexionAlumni = () => {
    const handleConnexionSuccess = () => {
        console.log('Connexion Alumni réussie');
        setTimeout(() => {
            globalThis.location.href = '/dashboard-alumni';
        }, 1500);
    };
            ...
            <div className="max-w-[1400px] mx-auto">
                <div className="flex flex-col lg:flex-row gap-16 items-center lg:items-start justify-center">
                    ...
                    <div className="w-full lg:w-auto lg:max-w-xl order-1 lg:order-2">
                        <FormulaireConnexionAlumni onSuccess={handleConnexionSuccess} />
                    </div>
                </div>
            </div>
        </div>

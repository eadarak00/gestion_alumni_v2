...
const FormulaireConnexionEtudiant = ({ onSuccess }) => {
    ...
    <div className="w-full max-w-md mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">
          Connexion <span className="text-emerald-600">Étudiant</span>
        </h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <p className="text-center text-sm text-gray-600">
          ...
          <a href="/inscription" className="text-emerald-600 hover:underline font-medium">
            S'inscrire
          </a>
        </p>
      </form>
...
FormulaireConnexionEtudiant.propTypes = {
  onSuccess: PropTypes.func,
};

export default FormulaireConnexionEtudiant;

...
public class FormationRequest {
    ...
    @Size(min = 2, max = 150, message = "Le diplôme doit contenir entre 2 et 150 caractères")
    private String diplome;
    
    @NotBlank(message = "L'établissement est obligatoire")
    @Size(min = 2, max = 150, message = "L'établissement doit contenir entre 2 et 150 caractères")

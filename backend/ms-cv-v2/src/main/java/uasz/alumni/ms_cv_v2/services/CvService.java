...
public class CvService {
    ...
    public CvResponseDTO updateCv(Long cvId, CvRequestDTO dto, Long userId) {
        ...
        if (dto.getCompetences() != null) {
            dto.getCompetences().forEach(c ->
                    existing.getCompetences().add(
                            Competence.builder()
                                    .nom(c.getNom())
                                    .niveau(c.getNiveau())
                                    .cv(existing)
        ...
        if (dto.getLangues() != null) {
            dto.getLangues().forEach(l ->
                    existing.getLangues().add(
                            Langue.builder()
                                    .nom(l.getNom())
                                    .niveau(l.getNiveau())
                                    .cv(existing)
        ...
        if (dto.getInterets() != null) {
            dto.getInterets().forEach(i ->
                    existing.getInterets().add(
                            Interet.builder()
